...
final class RMQRST_Admin_Notices {
	 ...
	 * Rate Us
	 */
	private $days_before_display_rate_us = 2;
	...
	private $suggestions = array(
		...
		'force-https-littlebizzy' => array(
			'name' => 'Force HTTPS',
			'desc' => 'Redirects all HTTP requests to the HTTPS version and fixes all insecure static resources by implementing secure URLs without altering the database.',
